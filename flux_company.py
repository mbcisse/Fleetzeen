...
def get_res_partner_service():
    ...
    for cmp in service:
        half_flow_odoo_topivotdb.full_half_flow_services_to_pivotdb(cmp['id'], cmp['subscriber_code_str'], cmp['name'], cmp['company_group_id'], cmp['parent_id'], cmp['subscriber_in'],cmp['subscriber_out'], cmp['mobile'], cmp['email'], cmp['street'], cmp['city'], cmp['zip'], cmp['country_id'], cmp['comment_for_operator'], cmp['comment_for_driver'])
    return service
